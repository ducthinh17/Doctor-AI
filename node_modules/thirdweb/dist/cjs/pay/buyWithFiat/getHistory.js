...
exports.getBuyWithFiatHistory = void 0;
...
async function getBuyWithFiatHistory(params) {
    try {
        ...
        const url = `${(0, definitions_js_1.getPayBuyWithFiatHistoryEndpoint)()}?${queryString}`;
...
exports.getBuyWithFiatHistory = getBuyWithFiatHistory;
