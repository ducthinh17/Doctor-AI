...
exports.toViemContract = exports.viemAdapter = void 0;
...
async function toViemContract(options) {
    return {
        ...
        abi: await (0, resolve_abi_js_1.resolveContractAbi)(options.thirdwebContract),
    };
}
exports.toViemContract = toViemContract;
