 ...
 * ```
 */
export declare function isEncryptedDataSupported(contract: ThirdwebContract<any>): Promise<boolean>;
/**
 ...
 * ```
 */
export declare function encodeEncryptedData(options: EncryptedDataParams): `0xa05112fc${string}`;
/**
