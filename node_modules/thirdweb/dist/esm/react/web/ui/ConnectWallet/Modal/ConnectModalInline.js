...
export const ConnectModalInline = (props) => {
    ...
    const modalSize = !canFitWideModal() || walletConfigs.length === 1
        ? "compact"
        : props.modalSize;
    return (_jsx(WalletUIStatesProvider, { theme: props.theme, isOpen: true, children: _jsx(ConnectModalInlineContent, { className: props.className, modalSize: modalSize }) }));
};
