...
function TransactionButton(props) {
    ...
    return ((0, jsx_runtime_1.jsxs)(buttons_js_1.Button, { gap: "xs", disabled: !account || disabled || isPending, variant: "primary", unstyled: unstyled, "data-is-loading": isPending, onClick: async (e) => {
            if (onClick) {
                onClick(e);
            }
            try {
