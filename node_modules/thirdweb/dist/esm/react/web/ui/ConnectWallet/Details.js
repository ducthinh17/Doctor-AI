    ...
    let content = (_jsxs("div", { children: [_jsx(Spacer, { y: "xl" }), _jsxs(Container, { px: "lg", flex: "column", center: "x", children: [ensAvatarQuery.data ? (_jsx(Img, { src: ensAvatarQuery.data, width: iconSize.xxl, height: iconSize.xxl, style: {
                        ...
                        gap: spacing.xs,
                            ...
                            gap: "1px",
                                    ...
                                    fontSize: fontSize.sm,
                                }, children: [_jsx(Img, { width: iconSize.md, height: iconSize.md, src: genericTokenIcon, client: client }), _jsx(Text, { color: "primaryText", children: "View Funds" })] }), activeWallet &&
                                isInAppWallet(activeWallet) &&
                                !activeWallet.getConfig()?.hidePrivateKeyExport && (_jsxs(MenuButton, { onClick: () => {
                                    setScreen("private-key");
                                }, style: {
                                    fontSize: fontSize.sm,
                                }, children: [_jsx(KeyIcon, { size: iconSize.md }), _jsx(Text, { color: "primaryText", children: "Export Private Key" })] })), _jsx(SwitchMetamaskAccount, { closeModal: () => setIsOpen(false) }), (props.detailsModal?.showTestnetFaucet ?? false) &&
