...
exports.decryptShareWeb = exports.encryptShareWeb = exports.getEncryptionKey = void 0;
...
async function decryptShareWeb(encryptedShareDetails, pwd) {
    ...
    // @ts-ignore - default import buils but ts doesn't like it
    const normalizedShare = await react_native_aes_gcm_crypto_1.default.decrypt(originalBase64CipherText, key, ivBufferHex.slice(2), // lib expects hex with no
