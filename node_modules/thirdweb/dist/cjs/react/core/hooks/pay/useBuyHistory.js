...
exports.useBuyHistory = void 0;
const react_query_1 = require("@tanstack/react-query");
const getBuyHistory_js_1 = require("../../../../pay/getBuyHistory.js");
/**
...
function useBuyHistory(params, queryParams) {
    return (0, react_query_1.useQuery)({
        ...
        queryFn: () => {
            ...
            return (0, getBuyHistory_js_1.getBuyHistory)(params);
        },
        enabled: !!params,
    });
}
exports.useBuyHistory = useBuyHistory;
