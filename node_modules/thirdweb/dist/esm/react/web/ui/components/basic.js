...
export function ModalHeader(props) {
    ...
    return (_jsxs("div", { style: {
            ...
            position: "relative",
                    ...
                    left: 0,
                    top: 0,
                } })), _jsx(Container, { flex: "row", gap: "xs", center: "both", children: typeof title === "string" ? _jsx(ModalTitle, { children: title }) : title })] }));
}
...
export function Container(props) {
    ...
    return (_jsx(Box, { "data-scrolly": props.scrollY, "data-animate": props.animate, bg: props.bg, color: props.color, borderColor: props.borderColor, style: {
            ...styles,
            ...props.style,
