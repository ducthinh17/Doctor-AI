...
export function PayEmbed(props) {
    ...
    if (!localeQuery.data) {
        ...
        content = (_jsxs(_Fragment, { children: [_jsx("div", { style: { display: screen === "tx-history" ? "none" : "inherit" }, children: _jsx(BuyScreen, { isEmbed: true, supportedTokens: props.supportedTokens, theme: theme, client: props.client, connectLocale: localeQuery.data, onViewPendingTx: () => {
                            ...
                            }, theme: theme }) }) }), screen === "tx-history" && (_jsx(BuyTxHistory, { client: props.client, onBack: () => {
                        setScreen("buy");
                    }, onDone: () => {
                        // noop
                    }, isBuyForTx: false, isEmbed: true }))] }));
    }
    return (_jsx(CustomThemeProvider, { theme: theme, children: _jsx(Container, { bg: "modalBg", style: {
