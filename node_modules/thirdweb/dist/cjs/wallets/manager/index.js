...
exports.getLastConnectedChain = exports.getStoredActiveWalletId = exports.getStoredConnectedWalletIds = exports.createConnectionManager = void 0;
const isSmartWallet_js_1 = require("../../react/web/utils/isSmartWallet.js");
...
function createConnectionManager(storage) {
    ...
    const onWalletDisconnect = (wallet) => {
        ...
        if (connectedWallets.getValue().length > 0) {
            const nextWallet = connectedWallets.getValue()[0];
    ...
    const handleConnection = async (wallet, options) => {
        ...
        if (options?.accountAbstraction && !isInAppSmartAccount) {
            activeWallet = (0, create_wallet_js_1.smartWallet)(options.accountAbstraction);
