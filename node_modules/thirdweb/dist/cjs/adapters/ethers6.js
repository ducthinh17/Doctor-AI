...
function toEthersSigner(ethers, client, account, chain) {
    class ThirdwebAdapterSigner extends ethers.AbstractSigner {
        ...
        async sendTransaction(tx) {
            ...
            const serializableTx = await (0, to_serializable_transaction_js_1.toSerializableTransaction)({
...
async function resolveEthers6Address(address) {
    ...
    if (resolvedAddress) {
        resolvedAddress = await (0, resolve_promised_value_js_1.resolvePromisedValue)(resolvedAddress);
    }
