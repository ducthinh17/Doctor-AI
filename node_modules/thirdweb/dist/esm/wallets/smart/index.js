...
import { broadcastZkTransaction, bundleUserOp, getUserOpReceipt, getZkPaymasterData, } from "./lib/bundler.js";
    ...
    const account = {
        ...
        async signTypedData(_typedData) {
            ...
            const [{ isContractDeployed }, { readContract }, { encodeAbiParameters }, { checkContractWalletSignedTypedData },] = await Promise.all([
                ...
                import("../../transaction/read-contract.js"),
                import("../../utils/abi/encodeAbiParameters.js"),
                import("../../extensions/erc1271/checkContractWalletSignedTypedData.js"),
            ]);
