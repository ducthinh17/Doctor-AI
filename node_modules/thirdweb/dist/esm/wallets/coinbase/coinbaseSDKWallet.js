 ...
 * @internal
 */
export async function connectCoinbaseWalletSDK(options, createOptions, emitter) {
 ...
 * @internal
 */
export async function autoConnectCoinbaseWalletSDK(options, createOptions, emitter) {
    const provider = await getCoinbaseProvider(createOptions);
    // connected accounts
