...
exports.storeShares = exports.setUpNewUserWallet = void 0;
...
async function createWalletShares() {
    ...
    const privateKeyHex = (0, hex_js_1.hexToUint8Array)((0, hex_js_1.stringToHex)(`thirdweb_${privateKey}`));
    ...
    const [share1, share2, share3] = await (0, shamir_secret_sharing_1.split)(privateKeyHex, 3, 2);
    ...
    return {
        ...
        shares: [
            (0, hex_js_1.uint8ArrayToHex)(share1),
            (0, hex_js_1.uint8ArrayToHex)(share2),
            (0, hex_js_1.uint8ArrayToHex)(share3),
        ],
    };
}
/**
