...
exports.isNativeAAChain = exports.hexlifyUserOp = exports.randomNonce = void 0;
const viem_1 = require("viem");
const zksync_sepolia_js_1 = require("../../../chains/chain-definitions/zksync-sepolia.js");
const zksync_js_1 = require("../../../chains/chain-definitions/zksync.js");
...
function isNativeAAChain(chain) {
    return chain.id === zksync_js_1.zkSync.id || chain.id === zksync_sepolia_js_1.zkSyncSepolia.id;
}
exports.isNativeAAChain = isNativeAAChain;
