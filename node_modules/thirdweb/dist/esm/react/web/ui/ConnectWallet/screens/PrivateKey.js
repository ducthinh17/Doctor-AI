            ...
            minHeight: "300px",
                    ...
                    maxHeight: "500px",
                                    ...
                                    zIndex: 11,
                                        ...
                                        setLoading(false);
                                    }, allow: "clipboard-read; clipboard-write", src: `https://${getThirdwebDomains().inAppWallet}/sdk/2022-08-12/embedded-wallet/export-private-key?clientId=${props.client.clientId}&theme=${typeof props.theme === "string" ? props.theme : props.theme.type}` }) })] }), _jsx(Spacer, { y: "lg" })] })] }));
}
