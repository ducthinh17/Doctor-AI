...
exports.getInstalledWalletProviders = exports.injectedProvider = void 0;
...
const mipdStore = /* @__PURE__ */ (() => (0, platform_js_1.isBrowser)() ? (0, mipd_1.createStore)() : undefined)();
/**
...
function getInstalledWalletProviders() {
    ...
    for (const provider of providers) {
        ...
        if (provider.info.rdns === "io.metamask.mobile") {
            provider.info.rdns = constants_js_1.METAMASK;
            break;
        }
    }
    return providers;
}
exports.getInstalledWalletProviders = getInstalledWalletProviders;
