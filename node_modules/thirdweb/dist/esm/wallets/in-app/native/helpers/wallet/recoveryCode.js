...
import { AWS_REGION, COGNITO_IDENTITY_POOL_ID, GENERATE_RECOVERY_PASSWORD_LAMBDA_FUNCTION, ROUTE_AUTH_COGNITO_ID_TOKEN, ROUTE_COGNITO_IDENTITY_POOL_URL, } from "../constants.js";
export async function getCognitoRecoveryPassword(client) {
    const idTokenResponse = await authFetchEmbeddedWalletUser(client, ROUTE_AUTH_COGNITO_ID_TOKEN, {
        method: "GET",
    });
    ...
    const params = {
        ...
        Payload: stringToBytes(JSON.stringify({
            accessToken,
            idToken,
        })),
    };
