import { AUTH_TOKEN_LOCAL_STORAGE_NAME, DEVICE_SHARE_LOCAL_STORAGE_NAME, PASSKEY_CREDENTIAL_ID_LOCAL_STORAGE_NAME, WALLET_CONNECT_SESSIONS_LOCAL_STORAGE_NAME, WALLET_USER_ID_LOCAL_STORAGE_NAME, } from "../../../core/constants/settings.js";
const data = new Map();
/**
 * @internal
 */
export class LocalStorage {
    ...
    async getWalletConnectSessions() {
        return this.getItem(WALLET_CONNECT_SESSIONS_LOCAL_STORAGE_NAME(this.clientId));
    }
    /**
     * @internal
     */
    async saveWalletConnectSessions(stringifiedSessions) {
        await this.setItem(WALLET_CONNECT_SESSIONS_LOCAL_STORAGE_NAME(this.clientId), stringifiedSessions);
    }
    /**
     * @internal
     */
