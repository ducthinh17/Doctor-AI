        ...
        switch (request.method) {
            ...
            case "eth_signTypedData_v4": {
                if (handlers?.eth_signTypedData) {
                    ...
                    const { handleSignTypedDataRequest } = await import("./request-handlers/sign-typed-data.js");
            ...
            case "eth_signTransaction": {
                if (handlers?.eth_signTransaction) {
                    ...
                    const { handleSignTransactionRequest } = await import("./request-handlers/sign-transaction.js");
            ...
            case "eth_sendTransaction": {
                ...
                if (handlers?.eth_sendTransaction) {
                    ...
                    const { handleSendTransactionRequest } = await import("./request-handlers/send-transaction.js");
            ...
            case "eth_sendRawTransaction": {
                ...
                if (handlers?.eth_sendRawTransaction) {
                    ...
                    const { handleSendRawTransactionRequest } = await import("./request-handlers/send-raw-transaction.js");
