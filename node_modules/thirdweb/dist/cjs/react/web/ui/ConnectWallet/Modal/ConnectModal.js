...
const ConnectModal = (props) => {
    ...
    return ((0, jsx_runtime_1.jsx)(Modal_js_1.Modal, { hide: hideModal, size: connectModal.size, open: isWalletModalOpen, setOpen: (value) => {
            if (hideModal) {
                return;
            }
            if (!value) {
        ...
        }, children: (0, jsx_runtime_1.jsx)(ConnectModalContent_js_1.ConnectModalContent, { shouldSetActive: props.shouldSetActive, screenSetup: screenSetup, setModalVisibility: setModalVisibility, isOpen: isWalletModalOpen, onClose: closeModal }) }));
};
