...
export const FN_SELECTOR = "0xd860483f";
const FN_INPUTS = [
    {
        type: "uint256",
        name: "index",
 ...
 * ```
 */
export async function isBaseURIIndicesSupported(contract) {
    return detectMethod({
        contract,
 ...
 * ```
 */
export function encodeBaseURIIndicesParams(options) {
 ...
 * ```
 */
export function encodeBaseURIIndices(options) {
    // we do a "manual" concat here to avoid the overhead of the "concatHex" function
    // we can do this because we know the specific formats of the values
    return (FN_SELECTOR +
        encodeBaseURIIndicesParams(options).slice(2));
}
/**
 ...
 * ```
 */
export function decodeBaseURIIndicesResult(result) {
 ...
 * ```
 */
export async function baseURIIndices(options) {
    return readContract({
...
//# sourceMappingURL=baseURIIndices.js.map