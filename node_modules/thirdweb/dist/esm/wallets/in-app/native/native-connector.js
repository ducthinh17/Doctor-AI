...
import { authEndpoint, customJwt, deleteActiveAccount, sendVerificationEmail, sendVerificationSms, socialLogin, validateEmailOTP, } from "./auth.js";
...
export class InAppNativeConnector {
    ...
    async socialLogin(oauthOption) {
        try {
            const { storedToken } = await socialLogin(oauthOption, this.options.client);
            const account = await this.getAccount();
            return {
                user: {
                    status: UserWalletStatus.LOGGED_IN_WALLET_INITIALIZED,
