...
const ConnectedWalletDetails = (props) => {
    ...
    const trigger = props.detailsButton?.render ? ((0, jsx_runtime_1.jsx)("div", { children: (0, jsx_runtime_1.jsx)(props.detailsButton.render, {}) })) : props.chain && isNetworkMismatch ? ((0, jsx_runtime_1.jsx)(jsx_runtime_1.Fragment, { children: (0, jsx_runtime_1.jsx)(SwitchNetworkButton, { style: props.switchButton?.style, className: props.switchButton?.className, switchNetworkBtnTitle: props.switchButton?.label, targetChain: props.chain }) })) : ((0, jsx_runtime_1.jsxs)(WalletInfoButton, { type: "button", className: `${TW_CONNECTED_WALLET} ${props.detailsButton?.className || ""}`, style: props.detailsButton?.style, "data-test": "connected-wallet-details", children: [ensAvatarQuery.data ? ((0, jsx_runtime_1.jsx)(Img_js_1.Img, { src: ensAvatarQuery.data, width: index_js_2.iconSize.lg, height: index_js_2.iconSize.lg, style: {
                    borderRadius: index_js_2.radius.sm,
                }, client: client })) : activeWallet?.id ? ((0, jsx_runtime_1.jsx)(WalletImage_js_1.WalletImage, { size: index_js_2.iconSize.lg, id: activeWallet.id, client: client })) : ((0, jsx_runtime_1.jsx)(WalletIcon_js_1.WalletIcon, { size: index_js_2.iconSize.lg })), (0, jsx_runtime_1.jsxs)(basic_js_1.Container, { flex: "column", gap: "xxs", children: [addressOrENS ? ((0, jsx_runtime_1.jsx)(text_js_1.Text, { size: "sm", color: "primaryText", weight: 500, className: `${TW_CONNECTED_WALLET}__address`, children: addressOrENS })) : ((0, jsx_runtime_1.jsx)(Skeleton_js_1.Skeleton, { height: index_js_2.fontSize.sm, width: "88px" })), balanceQuery.data ? ((0, jsx_runtime_1.jsxs)(text_js_1.Text, { className: `${TW_CONNECTED_WALLET}__balance`, size: "xs", weight: 500, children: [Number(balanceQuery.data.displayValue).toFixed(3), " ", balanceQuery.data.symbol] })) : ((0, jsx_runtime_1.jsx)(Skeleton_js_1.Skeleton, { height: index_js_2.fontSize.xs, width: "82px" }))] })] }));
    const networkSwitcherButton = ((0, jsx_runtime_1.jsxs)(MenuButton, { type: "button", disabled: disableSwitchChain, onClick: () => {
            setScreen("network-switcher");
                    ...
                    alignItems: "center",
                    position: "relative",
                }, children: chainQuery.data ? ((0, jsx_runtime_1.jsx)(ChainIcon_js_1.ChainIcon, { chainIcon: chainQuery.data?.icon, size: index_js_2.iconSize.md, active: true, client: client })) : ((0, jsx_runtime_1.jsx)(Skeleton_js_1.Skeleton, { height: index_js_2.iconSize.md, width: index_js_2.iconSize.md })) }), chainQuery.isLoading ? ((0, jsx_runtime_1.jsx)(Skeleton_js_1.Skeleton, { height: "16px", width: "200px" })) : ((0, jsx_runtime_1.jsx)(text_js_1.Text, { color: "primaryText", multiline: true, children: chainQuery.data?.name || `Unknown chain #${walletChain?.id}` })), (0, jsx_runtime_1.jsx)(StyledChevronRightIcon, { width: index_js_2.iconSize.sm, height: index_js_2.iconSize.sm, style: {
                    flexShrink: 0,
                    marginLeft: "auto",
                } })] }));
    let content = ((0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsx)(Spacer_js_1.Spacer, { y: "xl" }), (0, jsx_runtime_1.jsxs)(basic_js_1.Container, { px: "lg", flex: "column", center: "x", children: [ensAvatarQuery.data ? ((0, jsx_runtime_1.jsx)(Img_js_1.Img, { src: ensAvatarQuery.data, width: index_js_2.iconSize.xxl, height: index_js_2.iconSize.xxl, style: {
                            borderRadius: index_js_2.radius.lg,
                        }, client: client })) : activeWallet?.id ? ((0, jsx_runtime_1.jsx)(WalletImage_js_1.WalletImage, { size: index_js_2.iconSize.xxl, id: activeWallet.id, client: client })) : ((0, jsx_runtime_1.jsx)(WalletIcon_js_1.WalletIcon, { size: index_js_2.iconSize.xxl })), (0, jsx_runtime_1.jsx)(Spacer_js_1.Spacer, { y: "md" }), (0, jsx_runtime_1.jsx)(ConnectedToSmartWallet, {}), (activeWallet?.id === "embedded" || activeWallet?.id === "inApp") && ((0, jsx_runtime_1.jsx)(InAppWalletUserInfo, {})), (0, jsx_runtime_1.jsxs)("div", { style: {
                            display: "flex",
                            gap: index_js_2.spacing.xxs,
                            alignItems: "center",
                        ...
                        gap: index_js_2.spacing.xs,
                                ...
                                setScreen("send");
                            }, children: [(0, jsx_runtime_1.jsx)(basic_js_1.Container, { color: "secondaryText", flex: "row", center: "both", children: (0, jsx_runtime_1.jsx)(react_icons_1.PaperPlaneIcon, { width: index_js_2.iconSize.sm, height: index_js_2.iconSize.sm, style: {
                                ...
                                setScreen("receive");
                            }, children: [(0, jsx_runtime_1.jsxs)(basic_js_1.Container, { color: "secondaryText", flex: "row", center: "both", children: [(0, jsx_runtime_1.jsx)(react_icons_1.PinBottomIcon, { width: index_js_2.iconSize.sm, height: index_js_2.iconSize.sm }), " "] }), locale.receive, " "] }), (0, jsx_runtime_1.jsxs)(buttons_js_1.Button, { variant: "outline", style: {
                                fontSize: index_js_2.fontSize.sm,
                                display: "flex",
                                gap: index_js_2.spacing.xs,
                                alignItems: "center",
                                ...
                                setScreen("buy");
                            }, children: [(0, jsx_runtime_1.jsx)(basic_js_1.Container, { color: "secondaryText", flex: "row", center: "both", children: (0, jsx_runtime_1.jsx)(react_icons_1.PlusIcon, { width: index_js_2.iconSize.sm, height: index_js_2.iconSize.sm }) }), locale.buy] })] }) }), (0, jsx_runtime_1.jsx)(Spacer_js_1.Spacer, { y: "md" }), (0, jsx_runtime_1.jsxs)(basic_js_1.Container, { px: "md", children: [(0, jsx_runtime_1.jsxs)(basic_js_1.Container, { flex: "column", style: {
                            gap: "1px",
                        }, children: [networkSwitcherButton, (0, jsx_runtime_1.jsxs)(MenuButton, { onClick: () => {
                                    setScreen("pending-tx");
                                }, style: {
                                    fontSize: index_js_2.fontSize.sm,
                                }, children: [(0, jsx_runtime_1.jsx)(react_icons_1.TextAlignJustifyIcon, { width: index_js_2.iconSize.md, height: index_js_2.iconSize.md }), (0, jsx_runtime_1.jsx)(basic_js_1.Container, { flex: "row", gap: "xs", center: "y", children: (0, jsx_runtime_1.jsx)(text_js_1.Text, { color: "primaryText", children: locale.transactions }) })] }), (0, jsx_runtime_1.jsxs)(MenuButton, { onClick: () => {
                                    setScreen("view-funds");
                                }, style: {
                                    fontSize: index_js_2.fontSize.sm,
                                }, children: [(0, jsx_runtime_1.jsx)(Img_js_1.Img, { width: index_js_2.iconSize.md, height: index_js_2.iconSize.md, src: dataUris_js_1.genericTokenIcon, client: client }), (0, jsx_runtime_1.jsx)(text_js_1.Text, { color: "primaryText", children: "View Funds" })] }), activeWallet &&
                                (0, index_js_1.isInAppWallet)(activeWallet) &&
                                !activeWallet.getConfig()?.hidePrivateKeyExport && ((0, jsx_runtime_1.jsxs)(MenuButton, { onClick: () => {
                                    setScreen("private-key");
                                }, style: {
                                    fontSize: index_js_2.fontSize.sm,
                                }, children: [(0, jsx_runtime_1.jsx)(KeyIcon_js_1.KeyIcon, { size: index_js_2.iconSize.md }), (0, jsx_runtime_1.jsx)(text_js_1.Text, { color: "primaryText", children: "Export Private Key" })] })), (0, jsx_runtime_1.jsx)(SwitchMetamaskAccount, { closeModal: () => setIsOpen(false) }), (props.detailsModal?.showTestnetFaucet ?? false) &&
                                ((chainQuery.data?.faucets && chainQuery.data.faucets.length > 0) ||
                                    ...
                                    textDecoration: "none",
                                    color: "inherit",
                                }, children: [(0, jsx_runtime_1.jsx)(basic_js_1.Container, { flex: "row", center: "both", color: "secondaryText", children: (0, jsx_runtime_1.jsx)(FundsIcon_js_1.FundsIcon, { size: index_js_2.iconSize.md }) }), locale.requestTestnetFunds] })), props.detailsModal?.footer && ((0, jsx_runtime_1.jsx)(props.detailsModal.footer, { close: () => setIsOpen(false) }))] }), (0, jsx_runtime_1.jsx)(Spacer_js_1.Spacer, { y: "md" })] }), props.detailsModal?.hideDisconnect !== true && ((0, jsx_runtime_1.jsxs)(basic_js_1.Container, { children: [(0, jsx_runtime_1.jsx)(basic_js_1.Line, {}), (0, jsx_runtime_1.jsx)(Spacer_js_1.Spacer, { y: "sm" }), (0, jsx_runtime_1.jsx)(basic_js_1.Container, { px: "md", children: (0, jsx_runtime_1.jsxs)(MenuButton, { "data-variant": "danger", type: "button", onClick: () => {
                                if (activeWallet) {
                                    disconnect(activeWallet);
                                    props.onDisconnect();
                                }
                            }, children: [(0, jsx_runtime_1.jsx)(react_icons_1.ExitIcon, { width: index_js_2.iconSize.md, height: index_js_2.iconSize.md }), (0, jsx_runtime_1.jsx)(text_js_1.Text, { color: "primaryText", children: locale.disconnectWallet })] }) }), (0, jsx_runtime_1.jsx)(Spacer_js_1.Spacer, { y: "sm" })] }))] }));
...
const WalletInfoButton = /* @__PURE__ */ (0, elements_js_1.StyledButton)(() => {
    ...
    return {
        ...
        padding: `${index_js_2.spacing.sm} ${index_js_2.spacing.sm}`,
        borderRadius: index_js_2.radius.lg,
        cursor: "pointer",
        display: "inline-flex",
        alignItems: "center",
        ...
        [index_js_2.media.mobile]: {
            gap: index_js_2.spacing.sm,
            padding: `${index_js_2.spacing.xs} ${index_js_2.spacing.sm}`,
            img: {
                width: `${index_js_2.iconSize.md}px`,
                height: `${index_js_2.iconSize.md}px`,
            },
        },
        "&:hover": {
...
function ConnectedToSmartWallet() {
    ...
    const content = ((0, jsx_runtime_1.jsxs)(basic_js_1.Container, { flex: "row", bg: "secondaryButtonBg", gap: "xxs", style: {
            borderRadius: index_js_2.radius.md,
            padding: `${index_js_2.spacing.xxs} ${index_js_2.spacing.sm} ${index_js_2.spacing.xxs} ${index_js_2.spacing.xs}`,
        }, center: "y", children: [(0, jsx_runtime_1.jsx)(basic_js_1.Container, { flex: "row", color: "accentText", center: "both", children: (0, jsx_runtime_1.jsx)(SmartAccountBadgeIcon_js_1.SmartWalletBadgeIcon, { size: index_js_2.iconSize.xs }) }), (0, jsx_runtime_1.jsx)(text_js_1.Text, { size: "xs", color: "secondaryButtonText", children: locale.connectedToSmartWallet })] }));
...
function InAppWalletUserInfo() {
    ...
    if (userInfoQuery.data) {
        return ((0, jsx_runtime_1.jsx)(basic_js_1.Container, { flex: "row", center: "x", style: {
                paddingBottom: index_js_2.spacing.xs,
