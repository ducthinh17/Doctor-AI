...
const WalletConnectConnection = (props) => {
    ...
    const { chain, chains, client, walletConnect } = (0, useWalletConnectionCtx_js_1.useConnectUI)();
    ...
    return ((0, jsx_runtime_1.jsx)(ScanScreen_js_1.ScanScreen, { qrScanInstruction: locale.scanScreen.instruction, onBack: onBack, onGetStarted: onGetStarted, qrCodeUri: qrCodeUri, walletName: walletInfo.name, walletId: wallet.id, getStartedLink: locale.getStartedLink, error: errorConnecting, onRetry: connect }));
};
...
const WalletConnectStandaloneConnection = (props) => {
    ...
    if ((0, isMobile_js_1.isMobile)()) {
        return ((0, jsx_runtime_1.jsx)(ConnectingScreen_js_1.ConnectingScreen, { locale: {
                ...
                inProgress: locale.connectionScreen.inProgress,
                failed: locale.connectionScreen.failed,
            }, onBack: onBack, walletName: walletInfo.name, walletId: wallet.id, errorConnecting: errorConnecting, onRetry: connect }));
    }
    return ((0, jsx_runtime_1.jsx)(ScanScreen_js_1.ScanScreen, { qrScanInstruction: locale.scanScreen.instruction, onBack: onBack, qrCodeUri: qrCodeUri, walletName: walletInfo.name, walletId: wallet.id, getStartedLink: locale.getStartedLink, error: errorConnecting, onRetry: connect }));
};
