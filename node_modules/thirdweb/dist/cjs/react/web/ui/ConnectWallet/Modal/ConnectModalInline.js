...
const ConnectModalInline = (props) => {
    ...
    const modalSize = !(0, canFitWideModal_js_1.canFitWideModal)() || walletConfigs.length === 1
        ? "compact"
        : props.modalSize;
    return ((0, jsx_runtime_1.jsx)(wallet_ui_states_provider_js_1.WalletUIStatesProvider, { theme: props.theme, isOpen: true, children: (0, jsx_runtime_1.jsx)(ConnectModalInlineContent, { className: props.className, modalSize: modalSize }) }));
};
