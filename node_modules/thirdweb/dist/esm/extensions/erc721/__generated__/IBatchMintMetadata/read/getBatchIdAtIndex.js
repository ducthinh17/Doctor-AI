...
export const FN_SELECTOR = "0x2419f51b";
const FN_INPUTS = [
    {
        type: "uint256",
        name: "_index",
 ...
 * ```
 */
export async function isGetBatchIdAtIndexSupported(contract) {
    return detectMethod({
        contract,
 ...
 * ```
 */
export function encodeGetBatchIdAtIndexParams(options) {
 ...
 * ```
 */
export function encodeGetBatchIdAtIndex(options) {
 ...
 * ```
 */
export function decodeGetBatchIdAtIndexResult(result) {
 ...
 * ```
 */
export async function getBatchIdAtIndex(options) {
    return readContract({
