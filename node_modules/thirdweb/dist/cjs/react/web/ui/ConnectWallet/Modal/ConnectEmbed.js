...
function ConnectEmbed(props) {
    ...
    if (show) {
        ...
        return ((0, jsx_runtime_1.jsx)(wallet_connection_js_1.ConnectUIContext.Provider, { value: {
                ...
                auth: props.auth,
            }, children: (0, jsx_runtime_1.jsxs)(wallet_ui_states_provider_js_1.WalletUIStatesProvider, { theme: props.theme, isOpen: true, children: [(0, jsx_runtime_1.jsx)(ConnectEmbedContent, { ...props, onConnect: props.onConnect }), autoConnectComp] }) }));
    }
