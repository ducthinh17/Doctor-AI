            ...
            if (!isWalletGroupExpanded) {
                ...
                // social login + eoa wallets
                    ...
                    if (eoaWallets.length > 1) {
                        bottomSection = (_jsxs(Container, { flex: "column", style: { position: "relative" }, gap: "sm", children: [_jsx(GradientDiv, {}), _jsxs(Container, { px: "lg", flex: "column", gap: "md", children: [connectAWallet, continueAsGuest] }), tos ? (_jsxs(Container, { p: "md", children: [" ", tos, " "] })) : (_jsx(Spacer, { y: "xxs" }))] }));
                    }
