...
import { getDeviceShare, setAuthTokenClient, setWallerUserDetails, } from "../storage/local.js";
...
export async function postAuth({ storedToken, client, recoveryCode, }) {
...
export async function postAuthUserManaged(storedToken, client, password) {
