...
function PayEmbed(props) {
    ...
    if (!localeQuery.data) {
        ...
        content = ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)("div", { style: { display: screen === "tx-history" ? "none" : "inherit" }, children: (0, jsx_runtime_1.jsx)(BuyScreen_js_1.default, { isEmbed: true, supportedTokens: props.supportedTokens, theme: theme, client: props.client, connectLocale: localeQuery.data, onViewPendingTx: () => {
                            ...
                            }, theme: theme }) }) }), screen === "tx-history" && ((0, jsx_runtime_1.jsx)(BuyTxHistory_js_1.BuyTxHistory, { client: props.client, onBack: () => {
                        setScreen("buy");
                    }, onDone: () => {
                        // noop
                    }, isBuyForTx: false, isEmbed: true }))] }));
    }
    return ((0, jsx_runtime_1.jsx)(CustomThemeProvider_js_1.CustomThemeProvider, { theme: theme, children: (0, jsx_runtime_1.jsx)(basic_js_1.Container, { bg: "modalBg", style: {
