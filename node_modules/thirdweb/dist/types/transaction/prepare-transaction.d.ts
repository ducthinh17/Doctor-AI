...
type Additional<abi extends Abi = [], abiFn extends AbiFunction = AbiFunction> = {
    preparedMethod: () => Promise<PreparedMethod<abiFn>>;
    contract: ThirdwebContract<abi>;
};
export type PreparedTransaction<abi extends Abi = [], abiFn extends AbiFunction = AbiFunction, options extends PrepareTransactionOptions = PrepareTransactionOptions> = Readonly<options> & {
 ...
 * ```
 */
export declare function prepareTransaction<const abi extends Abi = [], const abiFn extends AbiFunction = AbiFunction>(options: PrepareTransactionOptions, info?: Additional<abi, abiFn>): PreparedTransaction<abi, abiFn, PrepareTransactionOptions>;
export {};
