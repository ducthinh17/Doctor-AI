...
function WalletSelector(props) {
    const { accountAbstraction } = (0, useWalletConnectionCtx_js_1.useConnectUI)();
    const [personalWallet, setPersonalWallet] = (0, react_1.useState)(null);
    if (!accountAbstraction) {
        return (0, jsx_runtime_1.jsx)(WalletSelectorInner, { ...props });
    }
    if (personalWallet) {
        return ((0, jsx_runtime_1.jsx)(SmartWalletConnectUI_js_1.SmartConnectUI, { accountAbstraction: accountAbstraction, done: props.done, personalWallet: personalWallet, setModalVisibility: props.setModalVisibility, onBack: props.goBack }));
    }
...
const WalletSelectorInner = (props) => {
    const { connectModal, isEmbed, client } = (0, useWalletConnectionCtx_js_1.useConnectUI)();
    ...
    const { connectLocale: locale, recommendedWallets } = (0, useWalletConnectionCtx_js_1.useConnectUI)();
    ...
    const eoaWallets = (0, sortWallets_js_1.sortWallets)(nonLocalWalletConfigs.filter((w) => w.id !== inAppWalletId), recommendedWallets);
    ...
    const twTitle = ((0, jsx_runtime_1.jsxs)(basic_js_1.Container, { gap: "xxs", center: "y", flex: "row", children: [!connectModal.titleIcon ? null : ((0, jsx_runtime_1.jsx)(Img_js_1.Img, { src: connectModal.titleIcon, width: index_js_1.iconSize.md, height: index_js_1.iconSize.md, client: client })), (0, jsx_runtime_1.jsxs)(modalElements_js_1.ModalTitle, { children: [" ", props.title, " "] })] }));
    ...
    const connectAWallet = ((0, jsx_runtime_1.jsx)(WalletTypeRowButton_js_1.WalletTypeRowButton, { client: client, icon: dataUris_js_1.genericWalletIcon, onClick: () => {
    ...
    const newToWallets = ((0, jsx_runtime_1.jsxs)(basic_js_1.Container, { flex: "row", style: {
        ...
        }, children: [(0, jsx_runtime_1.jsx)(text_js_2.Text, { color: "secondaryText", size: "sm", weight: 500, children: locale.newToWallets }), (0, jsx_runtime_1.jsx)(text_js_1.Link, { weight: 500, size: "sm", target: "_blank", href: "https://blog.thirdweb.com/web3-wallet/", children: locale.getStarted })] }));
    const tos = connectModal.termsOfServiceUrl || connectModal.privacyPolicyUrl ? ((0, jsx_runtime_1.jsx)(TOS_js_1.TOS, { termsOfServiceUrl: connectModal.termsOfServiceUrl, privacyPolicyUrl: connectModal.privacyPolicyUrl })) : undefined;
    let topSection;
    let bottomSection;
    // wide modal
    if (!isCompact) {
        topSection = ((0, jsx_runtime_1.jsx)(WalletSelection, { wallets: nonLocalWalletConfigs, selectWallet: handleSelect, done: props.done, goBack: props.goBack, onShowAll: props.onShowAll }));
        if (continueAsGuest) {
    ...
    // compact
        ...
        // social logins
            ...
            if (!isWalletGroupExpanded) {
                topSection = ((0, jsx_runtime_1.jsxs)(basic_js_1.Container, { px: "xs", children: [(0, jsx_runtime_1.jsx)(WalletSelection, { wallets: socialWallets, selectWallet: handleSelect, done: props.done, goBack: props.goBack }), eoaWallets.length > 0 && ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)(TextDivider_js_1.TextDivider, { text: locale.or }), (0, jsx_runtime_1.jsx)(Spacer_js_1.Spacer, { y: "lg" })] }))] }));
                ...
                // social login + eoa wallets
                    ...
                    // social login + single eoa wallet
                        ...
                        bottomSection = ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)(basic_js_1.Container, { px: "lg", children: (0, jsx_runtime_1.jsx)(WalletSelection, { wallets: eoaWallets, selectWallet: handleSelect, done: props.done, goBack: props.goBack, onShowAll: props.onShowAll }) }), continueAsGuest && ((0, jsx_runtime_1.jsx)(basic_js_1.Container, { flex: "column", px: "lg", gap: "lg", children: continueAsGuest })), tos ? ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [continueAsGuest ? (0, jsx_runtime_1.jsx)(Spacer_js_1.Spacer, { y: "md" }) : (0, jsx_runtime_1.jsx)(basic_js_1.Line, {}), (0, jsx_runtime_1.jsxs)(basic_js_1.Container, { p: "md", children: [" ", tos, " "] })] })) : ((0, jsx_runtime_1.jsx)(jsx_runtime_1.Fragment, { children: continueAsGuest && (0, jsx_runtime_1.jsx)(Spacer_js_1.Spacer, { y: "xl" }) }))] }));
                    }
                }
            }
            // expanded state
            else {
                topSection = ((0, jsx_runtime_1.jsx)(WalletSelection, { wallets: eoaWallets, selectWallet: handleSelect, done: props.done, goBack: props.goBack, onShowAll: props.onShowAll }));
    ...
    return ((0, jsx_runtime_1.jsxs)(basic_js_1.Container, { scrollY: true, flex: "column", animate: "fadein", fullHeight: true, style: {
            maxHeight: connectModal.size === "compact" ? constants_js_1.compactModalMaxHeight : undefined,
        }, children: [!isEmbed && ((0, jsx_runtime_1.jsx)(basic_js_1.Container, { p: "lg", children: isWalletGroupExpanded ? ((0, jsx_runtime_1.jsx)(basic_js_1.ModalHeader, { title: twTitle, onBack: () => {
                        setIsWalletGroupExpanded(false);
                    } })) : (twTitle) })), (0, jsx_runtime_1.jsxs)(basic_js_1.Container, { expand: true, scrollY: true, px: "md", style: isEmbed
                    ? {
                        paddingTop: index_js_1.spacing.lg,
                    }
                    : {
                        paddingTop: "2px",
                    }, children: [isEmbed && isWalletGroupExpanded && ((0, jsx_runtime_1.jsx)(basic_js_1.Container, { flex: "row", center: "y", style: {
                            ...
                            }, children: [(0, jsx_runtime_1.jsx)(react_icons_1.ChevronLeftIcon, { width: index_js_1.iconSize.sm, height: index_js_1.iconSize.sm }), locale.goBackButton] }) })), topSection] }), bottomSection, isCompact && connectModal.showThirdwebBranding !== false && ((0, jsx_runtime_1.jsx)(basic_js_1.Container, { py: "md", children: (0, jsx_runtime_1.jsx)(PoweredByTW_js_1.PoweredByThirdweb, {}) }))] }));
};
...
const WalletSelection = (props) => {
    const { recommendedWallets, showAllWallets, connectModal } = (0, useWalletConnectionCtx_js_1.useConnectUI)();
    const wallets = (0, sortWallets_js_1.sortWallets)(props.wallets, recommendedWallets);
    return ((0, jsx_runtime_1.jsxs)(WalletList, { style: {
            minHeight: "100%",
        }, children: [wallets.map((wallet) => {
                return ((0, jsx_runtime_1.jsx)("li", { children: wallet.id === "inApp" && connectModal.size === "compact" ? ((0, jsx_runtime_1.jsx)(react_1.Suspense, { fallback: (0, jsx_runtime_1.jsx)(LoadingScreen_js_1.LoadingScreen, { height: "195px" }), children: (0, jsx_runtime_1.jsx)(InAppWalletSelectionUI, { done: () => props.done(wallet), select: () => props.selectWallet(wallet), wallet: wallet, goBack: props.goBack }) })) : ((0, jsx_runtime_1.jsx)(WalletEntryButton_js_1.WalletEntryButton, { walletId: wallet.id, selectWallet: () => {
                            props.selectWallet(wallet);
                        } })) }, wallet.id));
            }), props.onShowAll && showAllWallets !== false && ((0, jsx_runtime_1.jsx)(ButtonContainer, { children: (0, jsx_runtime_1.jsxs)(WalletEntryButton_js_1.WalletButton, { onClick: props.onShowAll, children: [(0, jsx_runtime_1.jsxs)(ShowAllWalletsIcon, { children: [(0, jsx_runtime_1.jsx)("div", { "data-dot": true }), (0, jsx_runtime_1.jsx)("div", { "data-dot": true }), (0, jsx_runtime_1.jsx)("div", { "data-dot": true }), (0, jsx_runtime_1.jsx)("div", { "data-dot": true })] }), (0, jsx_runtime_1.jsxs)(basic_js_1.Container, { flex: "row", gap: "xs", children: [(0, jsx_runtime_1.jsx)(text_js_2.Text, { color: "primaryText", children: "All Wallets" }), (0, jsx_runtime_1.jsx)(BadgeText, { children: " 350+ " })] })] }) }))] }));
};
...
const GradientDiv = /* @__PURE__ */ (0, elements_js_1.StyledDiv)(() => {
    const theme = (0, CustomThemeProvider_js_1.useCustomTheme)();
