...
exports.populateEip712Transaction = exports.signEip712Transaction = exports.sendEip712Transaction = void 0;
...
async function populateEip712Transaction(options) {
    ...
    if (!gas || !maxFeePerGas || !maxPriorityFeePerGas) {
        ...
        gasPerPubdata = (0, bigint_js_1.toBigInt)(result.gas_per_pubdata_limit);
    }
