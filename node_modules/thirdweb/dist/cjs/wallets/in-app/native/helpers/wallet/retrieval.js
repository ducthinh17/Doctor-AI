...
exports.setUpShareForNewDevice = exports.getAccountAddressFromShares = exports.getExistingUserAccount = void 0;
...
async function getWalletPrivateKeyFromShares(shares) {
    const sharesData = shares.map((share) => (0, hex_js_1.hexToUint8Array)(share));
    const privateKeyHex = (0, uint8_array_js_1.uint8ArrayToString)(await (0, shamir_secret_sharing_1.combine)(sharesData));
