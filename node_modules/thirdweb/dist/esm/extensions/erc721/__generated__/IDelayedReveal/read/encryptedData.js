...
export const FN_SELECTOR = "0xa05112fc";
const FN_INPUTS = [
    {
        type: "uint256",
        name: "index",
 ...
 * ```
 */
export async function isEncryptedDataSupported(contract) {
    return detectMethod({
        contract,
 ...
 * ```
 */
export function encodeEncryptedDataParams(options) {
 ...
 * ```
 */
export function encodeEncryptedData(options) {
    // we do a "manual" concat here to avoid the overhead of the "concatHex" function
    // we can do this because we know the specific formats of the values
    return (FN_SELECTOR +
        encodeEncryptedDataParams(options).slice(2));
}
/**
 ...
 * ```
 */
export function decodeEncryptedDataResult(result) {
 ...
 * ```
 */
export async function encryptedData(options) {
    return readContract({
