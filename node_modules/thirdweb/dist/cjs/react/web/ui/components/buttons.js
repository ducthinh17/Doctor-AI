...
exports.InputButton = exports.IconButton = exports.ButtonLink = exports.Button = void 0;
...
exports.IconButton = (0, elements_js_1.StyledButton)(() => {
    const theme = (0, CustomThemeProvider_js_1.useCustomTheme)();
    return {
        all: "unset",
        cursor: "pointer",
...
exports.InputButton = (0, elements_js_1.StyledButton)(() => {
    const theme = (0, CustomThemeProvider_js_1.useCustomTheme)();
    return {
        all: "unset",
        display: "flex",
