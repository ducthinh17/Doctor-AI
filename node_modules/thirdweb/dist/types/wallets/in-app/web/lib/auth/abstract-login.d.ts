...
import type { AuthAndWalletRpcReturnType, AuthLoginReturnType, AuthProvider, SendEmailOtpReturnType } from "../../../core/authentication/type.js";
...
export declare abstract class AbstractLogin<MODAL = void, EMAIL_MODAL extends {
     ...
     * @internal
     */
    constructor({ baseUrl, querier, preLogin, postLogin, client, }: ClientIdWithQuerierType & {
        baseUrl: string;
