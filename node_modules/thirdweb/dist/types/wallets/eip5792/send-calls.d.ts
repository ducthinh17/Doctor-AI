...
export type PreparedSendCall<abi extends Abi = [], abiFunction extends AbiFunction = AbiFunction> = PreparedTransaction<abi, abiFunction, PrepareCallOptions>;
...
export {};
//# sourceMappingURL=send-calls.d.ts.map