...
export function TransactionButton(props) {
    ...
    return (_jsxs(Button, { gap: "xs", disabled: !account || disabled || isPending, variant: "primary", unstyled: unstyled, "data-is-loading": isPending, onClick: async (e) => {
            if (onClick) {
                onClick(e);
            }
            try {
            ...
            : {
                position: "relative",
                ...buttonProps.style,
            }, children: [_jsx("span", { style: { visibility: isPending ? "hidden" : "visible" }, children: children }), isPending && (_jsx("div", { style: {
                    position: "absolute",
                    display: "flex",
                    alignItems: "center",
                    height: "100%",
