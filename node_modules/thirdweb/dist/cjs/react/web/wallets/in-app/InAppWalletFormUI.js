...
const InAppWalletFormUI = (props) => {
    ...
    return ((0, jsx_runtime_1.jsxs)(basic_js_1.Container, { flex: "column", gap: "md", style: {
            position: "relative",
        }, children: [config?.metadata?.image && ((0, jsx_runtime_1.jsx)(basic_js_1.Container, { flex: "row", center: "both", children: (0, jsx_runtime_1.jsx)(Img_js_1.Img, { loading: "eager", client: client, style: {
                        maxHeight: "100px",
                        maxWidth: "300px",
